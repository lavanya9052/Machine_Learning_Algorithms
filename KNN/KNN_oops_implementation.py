...
class KNN:
    def __init__(self, path, default_k):
        try:
...
if __name__ == "__main__":
    try:
        path = input("Enter the path to your CSV file (including file name): ")
        default_k = int(input("Enter the default value for k: "))
        obj = KNN(path, default_k)
        print(f"\nTraining and testing with default k={default_k}")
        obj.training(default_k)
        obj.testing(default_k)
